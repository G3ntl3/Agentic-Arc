...
const Hero = () => {
  return (
    <>
      <div
        className="bg-cover bg-center bg-no-repeat w-[vw] md:overflow-hidden overflow-visible md:h-screen h-screen lg:h-full "
      ...
      >
        ...
        ></div>
        <div className=" items-center  absolute inset-0 bg-black/50 h-full  ">
          ...
          <div className="absolute inset-0   flex items-center justify-center flex-col">
            <div className="text-center mb-10">
              <div className="gradient-text bg-gradient-to-r from-[#00BFA6] to-[#016179] text-6xl px-20 mt-20 font-bold glowtext">
              ...
              {/* <span className="text-[36px] text-white px-30 mt-[-10px] text-center">
                their audience through powerful storytelling.
              </span>{" "} */}
            </div>
            <div className="text-[30px] text-white ">
              Making AI projects simple and connecting creators <br /> with
              their audience through powerful storytelling.
            </div>
